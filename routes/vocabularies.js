...
router.get("/", checkCredential(userRole.ADMIN), vocabulariesController.getAllVocabularies)
...
router.post("/add-many", checkCredential(userRole.ADMIN), vocabulariesController.createManyVocabulary)
